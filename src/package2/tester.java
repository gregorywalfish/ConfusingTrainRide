...
public class tester {
	...
	public static void main(String[] args) {
		...
		String testNameArray[] = new String[] { "TrainNetwork.getLineByName", "TrainNetwork.dance",
				"TrainNetwork.undance", "TrainNetwork.travel" };
		...
		for (int i = 0; i < stationArray.length; i++) {
			if (stationArray[i].hasConnection) {
				...
				current.setConnection(
						new TrainLine(dummyLeft, dummyRight, stationArray[i].getTransferLine().getName(), true),
						new TrainStation(stationArray[i].getTransferStation().getName()));
			}
	...
	public static TrainNetwork generateTrainNetwork1() {
		...
		/*
		 * TrainStation s1 = new TrainStation("1.Little Whinging"); TrainStation s5 =
		 * new TrainStation("5.St-Mungos");
		 * 
		 * TrainStation s2 = new TrainStation("2.Wizard Hat"); TrainStation s3 = new
		 * TrainStation("3.Hogsmeade"); TrainStation s4 = new
		 * TrainStation("4.Diagon Alley- 1/3");
		 * 
		 * TrainLine l1 = new TrainLine(new TrainStation[]{s1, s2, s3, s4, s5},
		 * "Scarlet", true);
		 */
